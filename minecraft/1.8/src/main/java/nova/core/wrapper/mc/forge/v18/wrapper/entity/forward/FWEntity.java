...
public class FWEntity extends net.minecraft.entity.Entity implements IEntityAdditionalSpawnData {
	...
	protected void readEntityFromNBT(NBTTagCompound nbt) {
		...
		if (wrapped == null) {
			...
			setWrapped(Game.entities().get(Data.unserialize(Game.natives().toNative(nbt.getTag("novaID")))).get().build());
		}
	}
	...
	protected void writeEntityToNBT(NBTTagCompound nbt) {
		...
		nbt.setTag("novaID", Game.natives().toNative(Data.serialize(wrapped.getID())));
	}
