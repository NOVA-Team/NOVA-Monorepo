...
public class FWSmartItemModel extends FWSmartModel implements ISmartItemModel, IFlexibleBakedModel {
	...
	public FWSmartItemModel(Item item) {
		...
		this.itemCameraTransforms = new net.minecraft.client.renderer.block.model.ItemCameraTransforms(
			new net.minecraft.client.renderer.block.model.ItemTransformVec3f(new Vector3f(0, -90, 130), new Vector3f(0, 1f / 24f, -2.75f / 16f), new Vector3f(0.9f, 0.9f, 0.9f)), // Third Person
			new net.minecraft.client.renderer.block.model.ItemTransformVec3f(new Vector3f(0, -135, 25/*-135/*-25*/), new Vector3f(0, 0.25f, 0.125f/*0.5f, 0.25f*/), new Vector3f(1.7f, 1.7f, 1.7f)), // First Person
			net.minecraft.client.renderer.block.model.ItemTransformVec3f.DEFAULT, // Head
			new net.minecraft.client.renderer.block.model.ItemTransformVec3f(new Vector3f(-30, 135, 0), new Vector3f(), new Vector3f(1.6F, 1.6F, 1.6F))); // GUI
	}
