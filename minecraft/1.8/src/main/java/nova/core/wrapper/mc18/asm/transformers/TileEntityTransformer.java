...
import nova.core.wrapper.mc18.asm.lib.InstructionComparator;
import nova.core.wrapper.mc18.asm.lib.ObfMapping;
...
public class TileEntityTransformer implements Transformer {
	...
	public void transform(ClassNode cnode) {
		...
		list.add(new MethodInsnNode(INVOKESTATIC, "nova/core/wrapper/mc18/asm/StaticForwarder", "loadTileEntityHook", "(Lnet/minecraft/nbt/NBTTagCompound;Ljava/lang/Class;)Lnet/minecraft/tileentity/TileEntity;", false));
