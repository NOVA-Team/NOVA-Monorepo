...
import nova.core.wrapper.mc.forge.v1_8.depmodules.ClientModule;
import nova.core.wrapper.mc.forge.v1_8.depmodules.ComponentModule;
import nova.core.wrapper.mc.forge.v1_8.depmodules.GameInfoModule;
import nova.core.wrapper.mc.forge.v1_8.depmodules.KeyModule;
import nova.core.wrapper.mc.forge.v1_8.depmodules.LanguageModule;
import nova.core.wrapper.mc.forge.v1_8.depmodules.NetworkModule;
import nova.core.wrapper.mc.forge.v1_8.depmodules.SaveModule;
import nova.core.wrapper.mc.forge.v1_8.depmodules.TickerModule;
import nova.core.wrapper.mc.forge.v1_8.wrapper.CategoryConverter;
...
import nova.core.wrapper.mc.forge.v1_8.wrapper.inventory.InventoryConverter;
import nova.core.wrapper.mc.forge.v1_8.wrapper.item.ItemConverter;
import nova.core.wrapper.mc.forge.v1_8.wrapper.item.OreDictionaryIntegration;
import nova.core.wrapper.mc.forge.v1_8.wrapper.recipes.MinecraftRecipeRegistry;
import nova.core.wrapper.mc.forge.v1_8.wrapper.recipes.RecipeConverter;
	...
	public void preInit(FMLPreInitializationEvent evt) {
		try {
			...
			net.minecraftforge.fml.common.ProgressManager.ProgressBar progressBar
				= net.minecraftforge.fml.common.ProgressManager.push("Loading NOVA mods", modClasses.isEmpty() ? 1 : modClasses.size());
			...
			//Load preInit
			progressBar = net.minecraftforge.fml.common.ProgressManager.push("Pre-initializing NOVA wrappers",
