...
package nova.core.wrapper.mc.forge.v1_8.wrapper.recipes;

import nova.core.wrapper.mc.forge.v1_8.wrapper.recipes.backward.MCCraftingRecipe;
import nova.core.wrapper.mc.forge.v1_8.wrapper.recipes.forward.NovaCraftingGrid;
...
import nova.core.wrapper.mc.forge.v1_8.wrapper.recipes.forward.NovaCraftingRecipe;
import nova.core.wrapper.mc.forge.v1_8.wrapper.recipes.forward.ShapedRecipeBasic;
import nova.core.wrapper.mc.forge.v1_8.wrapper.recipes.forward.ShapedRecipeOre;
import nova.core.wrapper.mc.forge.v1_8.wrapper.recipes.forward.ShapelessRecipeBasic;
import nova.core.wrapper.mc.forge.v1_8.wrapper.recipes.forward.ShapelessRecipeOre;
...
public class RecipeConverter implements NativeConverter<CraftingRecipe, IRecipe> {
	...
	public CraftingRecipe toNova(IRecipe recipe) {
		...
		if (recipe instanceof ShapelessRecipes) {
			...
			int height = shaped.getRecipeSize() / width;
